  ...
  return (
    ...
    >
      ...
      <div className="section-container flex flex-col justify-center">
        ...
        <form className="staggered-reveal pt-10 sm:mx-auto sm:w-[30rem] md:w-[35rem]">
          <Fade bottom distance={"4rem"}>
            <div className="relative">
              <input
                type="text"
                id="name"
                className="block h-12 w-full rounded-[0.6rem] border-2 border-purple bg-transparent px-4 font-mono text-xl outline-none transition-all duration-200 sm:h-14 sm:text-2xl"
                value={formData.name}
              ...
              <label
                htmlFor="name"
                className="absolute left-0 top-0 flex h-full transform items-center pl-4 font-mono text-lg transition-all"
              >
                Name
              </label>
            </div>
            ...
            <div className="relative mt-14">
              <textarea
                id="message"
                className="block h-auto max-h-[20rem] min-h-[10rem] w-full rounded-[0.6rem] border-2 border-purple bg-transparent px-4 py-2 font-mono text-xl outline-none transition-all duration-200 sm:h-14 sm:text-2xl"
              ...
              <label
                htmlFor="message"
                className="absolute left-0 top-0 flex h-14 transform items-center pl-4 font-mono text-lg transition-all"
              >
                Message
              </label>
            </div>
        ...
        <div className="link mx-auto mt-9">
          <button
